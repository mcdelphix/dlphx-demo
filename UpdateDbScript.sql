...
SET PHONE_NUMBER = '(03)53869208', EMAIL='bigkahuna@outlook.com', ADDRESS = '8 Exhibition St'
WHERE PATIENT_ID = 1
GO

UPDATE MEDICAL_RECORDS
SET PHONE_NUMBER = '(08)90768726', EMAIL='max.kelly@optus.com.au', ADDRESS = '81 Carrington St'
WHERE PATIENT_ID = 2
GO

UPDATE MEDICAL_RECORDS
SET PHONE_NUMBER = '(02)43453310', EMAIL='topdog44@telstra.com', ADDRESS = '15 Regent St'
WHERE PATIENT_ID = 3
GO

UPDATE MEDICAL_RECORDS
SET PHONE_NUMBER = '(03)53256749', EMAIL='chloelee@optus.com.au', ADDRESS = '208 Eighth St'
WHERE PATIENT_ID = 4
GO

UPDATE MEDICAL_RECORDS
SET PHONE_NUMBER = '(07)34023774', EMAIL='angelfish@tpg.com.au', ADDRESS = '4 Wade St'
WHERE PATIENT_ID = 5
GO
...
SET PHONE_NUMBER = '(03)53869208'
WHERE PATIENT_ID = 1
GO

UPDATE PATIENT_DETAILS
SET PHONE_NUMBER = '(08)90768726'
WHERE PATIENT_ID = 2
GO
	
UPDATE PATIENT_DETAILS
SET PHONE_NUMBER = '(02)43453310'
WHERE PATIENT_ID = 3
GO
	
UPDATE PATIENT_DETAILS
SET PHONE_NUMBER = '(03)53256749'
WHERE PATIENT_ID = 4
GO
